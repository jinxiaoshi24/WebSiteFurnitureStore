                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="#"><i class="fa fa-envelope"></i>ntkha@gmail.com</a></li>
                                ...
                                <ul class="list-unstyled list-inline">
                                        <li class="dropdown dropdown-small">
                                            ...
                                            <ul class="dropdown-menu con">
                                                <li><a href="order.php"><i class="fa fa-list-alt"></i> Đơn hàng của tôi</a></li>
                                                <li><a data-toggle="modal" data-target="#myDoiMatKhau"><i class="fa fa-retweet"></i> Đổi mật khẩu</a></li>
                                                <li><a href="javascript:var r=confirm('Bạn muốn đăng xuất?');if(r==true) window.location='dang_xuat.php'"><i class="fa fa-sign-out"></i> Đăng Xuất</a></li>
